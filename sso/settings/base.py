...
GRANT_MINUTES_EXPIRED_MINUTES = env.int("GRANT_MINUTES_EXPIRED_MINUTES")
ACCESS_TOKEN_EXPIRED_DAYS = env.int("ACCESS_TOKEN_EXPIRED_DAYS")
REFRESH_TOKEN_EXPIRED_DAYS = env.int("REFRESH_TOKEN_EXPIRED_DAYS")
REFRESH_TOKEN_EXPIRED_HOURS = env.int("REFRESH_TOKEN_EXPIRED_HOURS")
VERIFICATION_EXPIRED_MINUTES = env.int("VERIFICATION_EXPIRED_MINUTES")
...
MAX_FAILED_LOGIN_ATTEMPT = env.int("MAX_FAILED_LOGIN_ATTEMPT")
